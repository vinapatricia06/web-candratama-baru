...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('maintenances.index') }}" method="GET" class="mb-3 d-flex flex-wrap gap-2"
            ...
            <div class="input-group me-2" style="max-width: 150px;">
                <input type="number" name="tanggal" class="form-control" min="1" max="31"
                    placeholder="Tanggal" value="{{ request()->get('tanggal') }}">
            </div>
                            ...
                            <td>
                                @if ($maintenance->dokumentasi)
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#imageModal"
                                        onclick="showImage('{{ asset($maintenance->dokumentasi) }}')">
