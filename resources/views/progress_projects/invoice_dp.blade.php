...
<body>
    ...
    <div class="header">
        ...
        <br>
        <h2>INVOICE TAGIHAN PEMBAYARAN UANG MUKA</h2>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="right">Total Pembayaran Project</th>
                <th class="right">Total Tagihan Uang Muka</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                ...
                <td class="right">{{ 'Rp ' . number_format($data['nominal'], 0, ',', '.') }}</td>
                <td class="right">{{ 'Rp ' . number_format($data['uang_muka'], 0, ',', '.') }}</td>
            </tr>
        </tbody>
    </table>
