            ...
            <div class="col-md-8">
                <div class="card elevation-3 border-0 shadow-lg">
                    <div class="card-body text-center">
                        ...
                        <h3 class="text-success font-weight-bold mb-3">Pembayaran Angsuran Berhasil!</h3>
                        <p class="lead">Terima kasih atas pembayaran angsuran Anda. Transaksi Anda telah berhasil diproses.
                        </p>
