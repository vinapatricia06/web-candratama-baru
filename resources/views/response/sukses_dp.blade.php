...
@section('title', 'Pembayaran Uang Muka Berhasil')
            ...
            <div class="col-md-8">
                <div class="card elevation-3 border-0 shadow-lg">
                    <div class="card-body text-center">
                        ...
                        <h3 class="text-success font-weight-bold mb-3">Pembayaran Uang Muka Berhasil!</h3>
                        ...
                        <div class="mt-4">
                            <a href="{{ route('progress_projects.index') }}" class="btn btn-success btn-lg mr-2">
