...
@section('content')
    ...
    @endif
        ...
        <!-- Year Filter Form -->
        <form action="{{ route('surat.purchasing.filterByYear') }}" method="GET">
            @csrf
            <div class="mb-3">
        ...
        <form action="{{ route('surat.purchasing.deleteByYear') }}" method="POST" style="margin-bottom: 20px;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus semua data untuk tahun {{ request('year') }}?');">
            @csrf
